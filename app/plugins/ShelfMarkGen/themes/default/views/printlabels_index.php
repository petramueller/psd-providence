		...
		$(function(){
			...
			$("#printButton").click(function(e){
				...
				$.get(tudUrlRoot + "/index.php/find/SearchObjects/Index/reset/preference:persistent_search")
					.done(function(){
						$.fileDownload(tudUrlRoot + "/index.php/ShelfMarkGen/PrintLabels/Download", { //"/index.php/find/SearchObjects/Index"
							preparingMessageHtml: "We are preparing your report, please wait...",
							failMessageHtml: "There was a problem generating your report, please try again.",
							httpMethod: "POST",
							data: {"_formName" : "BasicSearchForm", "form_timestamp" : timeStamp, "search" : generateSearchExpression() }
						});
